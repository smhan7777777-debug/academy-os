...
export async function startStudio() {
  ...
  function render() {
    ...
    }</main><footer class="st-footer"><span>배움결 · 원장님의 기준으로, 한 걸음씩.</span><span>${api.auth.demo ? "예시 학원 · 로컬 체험" : "로컬 계정"} · 서버 저장 · 외부 문자 미연결</span></footer></div>`;
    filterLibrary();
  }
